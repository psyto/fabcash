...
Technical documentation of privacy technologies, threat model, and implementation details.

> For philosophy and motivation, see [README.md](README.md).
...
| Doc | Description |
|-----|-------------|
| **[README.md](README.md)** | Philosophy, pitch, getting started |
| **[SECURITY.md](SECURITY.md)** | Key handling, cryptographic primitives |
| **[GUIDE.md](GUIDE.md)** | User guide, payment flows |
